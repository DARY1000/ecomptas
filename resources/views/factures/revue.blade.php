                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="number" name="montant_ttc" step="1" min="0" required
                               ...
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 font-semibold">
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                ...
                <div class="mt-5 pt-4 border-t border-gray-100">
                    ...
                    <textarea name="commentaire_rejet" rows="3"
                              ...
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 resize-none">{{ old('commentaire_rejet') }}</textarea>
                </div>
            </div>
        </div>
