                    ...
                    <div>
                        ...
                        <dd class="mt-0.5">
                            ...
                            <span class="px-2 py-0.5 rounded text-xs font-medium
                                {{ $facture->type_document === 'VENTE' ? 'bg-green-100 text-green-700' : ($facture->type_document === 'ACHAT' ? 'bg-sky-100 text-sky-700' : 'bg-purple-100 text-purple-700') }}">
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="border-b border-gray-100">
                    <nav class="flex">
                        <button type="button"
                                @click="tab = 'ecritures'"
                                :class="tab === 'ecritures' ? 'border-emerald-600 text-emerald-700' : 'border-transparent text-gray-500 hover:text-gray-700'"
                        ...
                        <button type="button"
                                @click="tab = 'logs'"
                                :class="tab === 'logs' ? 'border-emerald-600 text-emerald-700' : 'border-transparent text-gray-500 hover:text-gray-700'"
                                class="px-5 py-3 text-sm font-medium border-b-2 transition">
                            Historique
                        </button>
                        ...
                        <button type="button"
                                @click="tab = 'raw'"
                                :class="tab === 'raw' ? 'border-emerald-600 text-emerald-700' : 'border-transparent text-gray-500 hover:text-gray-700'"
                                class="px-5 py-3 text-sm font-medium border-b-2 transition">
                            Données brutes
                        </button>
                        @endif
