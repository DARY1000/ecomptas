...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { background: linear-gradient(135deg, #065f46 0%, #047857 100%); padding: 32px 32px 28px; text-align: center; }
        ...
        .btn { display: inline-block; background: #047857; color: #ffffff !important; font-weight: 700; font-size: 15px; padding: 14px 32px; border-radius: 10px; text-decoration: none; margin: 16px 0 0; }
...
<div class="wrapper">
    <div class="card">
        ...
        <div class="header">
            <div>
                <div class="logo-icon">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#047857" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="receipt">
                ...
                <div class="receipt-row">
                    ...
                    <span class="receipt-value">
                        {{ $abonnement->debut_le->format('d/m/Y') }} → {{ $abonnement->expire_le->format('d/m/Y') }}
                    </span>
                </div>
                @endif
                <div class="receipt-row">
