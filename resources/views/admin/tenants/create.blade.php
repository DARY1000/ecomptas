...
<div class="max-w-2xl mx-auto space-y-5">
    ...
    <form method="POST" action="{{ route('admin.tenants.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" name="admin_password" value="{{ old('admin_password', Str::random(12)) }}" required
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 font-mono">
                </div>
        ...
        <div class="flex gap-3 justify-end">
            ...
            <button type="submit"
                    class="px-5 py-2.5 bg-emerald-900 text-white rounded-lg hover:bg-emerald-900 transition text-sm font-semibold flex items-center gap-2">
